	...
	<div class="max-w-4xl mx-auto">
		...
		{#key selectedQuote}
			...
			>
				...
				<div
					class="flex w-full md:w-1/2 justify-center flex-col flex-1 px-xx-small py-xx-small md:py-0 sm:pl-x-small lg:pl-x-small lg:pr-0"
					in:fade={{ delay: 100 }}
				>
					<p class="text-medium">
					...
					<p class="font-bold mt-xx-small text-small">
